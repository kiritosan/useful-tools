...
type handleInputChangeType = (e: React.ChangeEvent<HTMLInputElement>, inputName: string) => void

const InputGroupComponent: React.FC<{ inputValues: InputValues; handleInputChange: handleInputChangeType }> = ({ inputValues, handleInputChange }) => {
